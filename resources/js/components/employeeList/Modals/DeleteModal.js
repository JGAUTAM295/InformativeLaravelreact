...
class DeleteModal extends Component {
    ...
    deletecustomerData = (customer) => {
        axios.delete('/delete/customer/data/' + customer).then(() => {
            ...
            <div className="modal fade" id={"deleteModal"+this.props.modalId } tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">Customer Delete</h5>
                    ...
                    <div className="modal-body">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button"
                                ...
                                onClick={ () => {this.deletecustomerData(this.props.modalId)}}>
                                Yes
                            </button>
                            <button type="button"
